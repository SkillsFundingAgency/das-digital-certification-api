...
(
    [Id] UNIQUEIDENTIFIER NOT NULL CONSTRAINT [DF_UserAuthorisation_Id] DEFAULT NEWID() PRIMARY KEY,
    [UserId] UNIQUEIDENTIFIER NOT NULL,
    [ULN] BIGINT NOT NULL,
    [AuthorisedAt] DATETIME2 NOT NULL CONSTRAINT [DF_UserAuthorisation_AuthorisedAt] DEFAULT SYSUTCDATETIME()
)
GO
