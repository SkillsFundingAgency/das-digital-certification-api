...
(
    [Id] UNIQUEIDENTIFIER NOT NULL CONSTRAINT [DF_SharingEmail_Id] DEFAULT NEWID() PRIMARY KEY,
    [SharingId] UNIQUEIDENTIFIER NOT NULL,
    [EmailAddress] VARCHAR(254) NOT NULL,
    [EmailLinkCode] UNIQUEIDENTIFIER NOT NULL CONSTRAINT [DF_SharingEmail_EmailLinkCode] DEFAULT NEWID(),
    [SentTime] DATETIME2 NOT NULL CONSTRAINT [DF_SharingEmail_SentTime] DEFAULT SYSUTCDATETIME(),
