...
(
    [Id] UNIQUEIDENTIFIER NOT NULL CONSTRAINT [DF_SharingAccess_Id] DEFAULT NEWID() PRIMARY KEY,
    [SharingId] UNIQUEIDENTIFIER NOT NULL,
    [AccessedAt] DATETIME2 NOT NULL CONSTRAINT [DF_SharingAccess_AccessedAt] DEFAULT SYSUTCDATETIME(),
