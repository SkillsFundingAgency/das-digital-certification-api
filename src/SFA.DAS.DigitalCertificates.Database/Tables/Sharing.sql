...
(
    [Id] UNIQUEIDENTIFIER NOT NULL CONSTRAINT [DF_Sharing_Id] DEFAULT NEWID() PRIMARY KEY,
    [UserId] UNIQUEIDENTIFIER NOT NULL,
    [CertificateId] UNIQUEIDENTIFIER NOT NULL,
    [CertificateType] VARCHAR(20) NOT NULL,
    [CourseName] VARCHAR(1000) NOT NULL,
    [LinkCode] UNIQUEIDENTIFIER NOT NULL CONSTRAINT [DF_Sharing_LinkCode] DEFAULT NEWID(),
    [CreatedAt] DATETIME2 NOT NULL CONSTRAINT [DF_Sharing_CreatedAt] DEFAULT SYSUTCDATETIME(),
