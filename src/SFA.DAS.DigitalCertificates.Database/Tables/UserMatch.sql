...
(
    [Id] UNIQUEIDENTIFIER NOT NULL CONSTRAINT [DF_UserMatch_Id] DEFAULT NEWID() PRIMARY KEY,
    [UserId] UNIQUEIDENTIFIER NOT NULL,
    [Uln] BIGINT NULL,
    [FamilyName] VARCHAR(255) NOT NULL,
    [DateOfBirth] DATE NOT NULL,
    [EventTime] DATETIME2 NOT NULL CONSTRAINT [DF_UserMatch_EventTime] DEFAULT SYSUTCDATETIME(),
